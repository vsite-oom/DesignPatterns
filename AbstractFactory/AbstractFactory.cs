namespace DesignPatterns.AbstractFactory
{
    ...
    // 012a Add EllipseShape derived from Shape class.
    ...
    //012b Extend ShapesFactory classes with CreateEllipses methods.
    ...
    internal abstract class AbstractShapesFactory
    {
        ...
        {
            var ellipses = new List<Shape>();
            foreach (var bound in bounds)
            {
                ellipses.Add(new EllipseShape(bound, pen, brush));
            }
            return ellipses;
        }
